...
<Dropcap>
  Normalization is a database design methodology [[the great
  font heist]]. Proposed by Edgar F. Codd in 1970 - and
  subsequently developed in the following years with some
  collaborators - database normalization gives us a
  framework for structuring relational (usually) databases.
...
2. It can easily lead to corrupted data, thanks to <a href="#update-anomalies">update anomalies</a>.
