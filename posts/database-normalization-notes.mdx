...
Data _redundancy_ is the duplication [[How to conditionally add a property to an object]] of data in multiple records. Whether the data is recorded in the same
