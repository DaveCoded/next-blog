...
thelittlemermaid@fairytales.com, I want to know that running the same query will return me the same
...
slightly complex and beyond the scope of this introduction. In short, a relation (table) "that does
not have multiple overlapping candidate keys is guaranteed to be in BCNF" (Vincent, M. W. and B. Srinivasan.
"A Note on Randi Schemes Which Are in 3NF But Not in BCNF". Information Processing Letters 48(6), 1993, pp. 281–283)
