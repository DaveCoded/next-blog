...
Data _redundancy_ is the <InternalLink href="/blog">duplication of data</InternalLink> in multiple records. Whether the data is recorded in the same
...
It will then be possible to get two different answers to the same query. [link to Google](https://www.google.com)
