...
can be difficult to decipher, and has its limitations.
<MarginNote id={1}>
  See, for example, [this incredible answer](https://stackoverflow.com/a/1732454) on Stack
  Overflow about matching HTML tags with regex
</MarginNote>
