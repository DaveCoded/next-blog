...
<p>
  ...
  most options and flexibility. The
  <MarginNote id={1}>Oh hello darling</MarginNote> only reason
  to avoid it might be that you get too much control, which puts
  the onus of understanding how to optimise web fonts all on
