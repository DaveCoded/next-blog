...
<Dropcap>Self-hosting</Dropcap> web fonts is the best font-loading strategy for many websites.
Done correctly, it yields the best performance results and gives you the most options and flexibility.
