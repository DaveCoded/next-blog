...
<Dropcap>
  Poor Jane. Her insightful, [[How to conditionally add a
  property to an object]] sensitive, entertaining work has
  been co-opted by mysoginy, by people wanting to give Colin
  Firth something to do, and now by yet another React
