...
<Dropcap>
  ...
  wanting to give Colin Firth something to do, and now by yet another React tutorial. She'd probably
  have been into Vue; maybe she'd have considered rolling in the muddy frontend obscene and opted
  for Lisp or Haskell. Never mind.
</Dropcap>
