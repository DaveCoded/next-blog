---
title: 'Read the docs. The whole thing.'
...
<p>
  <Dropcap>I</Dropcap> had never read <em>all of</em> the documentation for a technology
  from start to finish before last week. I'm currently working through Josh Comeau's
  ...
  </MarginNote> I chose to use styled-components for this blog because I wanted to learn it;
  it's popular and I was seeking to understand the debates around css-in-js by trying it out
  myself. But after installing it and learning how to add CSS styles, I didn't dig any further.
  It turns out, I was missing out on a whole mental model.
</p>

<!-- TODO: Turn this into some component instead of being an h2 -->

## Intended audience

You don't need to know anything about styled-components, but you'll get more out of this
if you do. Otherwise, developers and technical writers who think about documentation and
developers interested in learning technologies well.

## Why did I decide to read all the docs?

Regarding styled-componets, I already knew everything I _needed_ to. I knew how to style
components dynamically based on their props. I knew about the `createGlobalStyle` function
for, yep you guessed it, creating global styles. But occasionally I found myself doing
things I didn't like. I would create extra wrappers - unnecessarily polluting the DOM with
more `<div>` elements - or sometimes style nested elements from a parent comopnent. And
although I couldn't identify why I disliked it, I trusted my instincts and decided to find
out what I was doing wrong.

Also, in one of my interviews for a company I'll be joining soon, it sounded like they
were considering adopting styled-components. It seemed like the opportune moment to become
an expert on styled-components. And if you want to know everything about a technology,
then you better have read the documentation, right?<MarginNote id={2}>This isn't actually
rhetorical. Mastering a technology takes more than just reading the docs. And reading all
of the documentation is only as useful as the documentation is good.</MarginNote>

## Developing a docs-reading habit

Another reason is that I wanted to practice reading documentation. And the
styled-components docs are relatively short, so this was a good place to start. They took
me a little over an hour to read at a careful pace, so much less than an hour if you want
to skim them. They are also very approachably organised. You don't suffer from sidebar
overwhelm.

[**Add pics side by side of styled-components sidebar with another overwhelming docs
site**]
