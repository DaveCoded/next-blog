...
<Dropcap>Well</Dropcap> ok then, you got me. Maybe that title is overly spicy.<MarginNote
  id={1}
>
...
honest, writing tests can be difficult, and it's not always our fault. I'm not a fan of
blaming tools, but given the choice, I'd use Jest and React Testing Library over Mocha and
Enzyme, even though I'm less familiar with both. That said, allow me to show you the
