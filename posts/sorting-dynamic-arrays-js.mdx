...
<Dropcap>
  ...
  from longest to shortest, or anything a computer can calculate. You want to sort them by something
  that seems, at least to a dumb computer, entirely arbitrary (laughable, even). Alphabetically by
  which letter maps to your favourite numbers between 1 and 26. Or according to a list of label
